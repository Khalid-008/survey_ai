...
var script2 = {
  ...
  methods: {
    initChart: function initChart() {
      var _this = this;
      import("./auto-VIV3S7VJ.js").then(function(module) {
        if (_this.chart) {
          _this.chart.destroy();
          _this.chart = null;
        }
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _objectSpread2(_objectSpread2({}, _ctx.canvasProps), _ctx.ptm("canvas"))), null, 16, _hoisted_1)], 16);
}
